...
export default function Create({ sectors }) {
    ...
    const conditions = [
        { value: 'NOVO', label: 'Novo', color: 'text-green-600', bgColor: 'bg-green-50', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
        { value: 'BOM', label: 'Bom', color: 'text-blue-600', bgColor: 'bg-blue-50', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
        { value: 'REGULAR', label: 'Regular', color: 'text-yellow-600', bgColor: 'bg-yellow-50', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z' },
        { value: 'RUIM', label: 'Ruim', color: 'text-orange-600', bgColor: 'bg-orange-50', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z' },
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Adicionar novo item ao patrimônio</p>
                        </div>
                    </div>
                    <a
