                                ...
                                <div className="px-4 py-5 sm:p-6">
                                    ...
                                    <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <dd className="mt-1 text-sm text-gray-900">{asset.serial_number || 'Não informado'}</dd>
                                        </div>
                                        <div>
                                            <dt className="text-sm font-medium text-gray-500 flex items-center">
                                                <svg className="mr-2 h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <dd className="mt-1 text-sm text-gray-900">{asset.patrimony_number || 'Não informado'}</dd>
                                        </div>
                                        <div>
                                            <dt className="text-sm font-medium text-gray-500 flex items-center">
                                                <svg className="mr-2 h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
