                    ...
                    <nav class="flex-1 px-2 space-y-1">
                        @php
                            ...
                            if (auth()->user()->hasRole('admin')) {
                                $navItems[] = ['name' => 'Usuários', 'route' => 'admin.users', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z'];
                                $navItems[] = ['name' => 'Logs de Auditoria', 'route' => 'admin.audit-logs', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'];
                            }
                        @endphp
