                ...
                <div class="p-6 text-gray-900">
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-input-label for="name" :value="__('Asset Name / Description')" />
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" wire:click="generateQrCode" class="mt-1 px-4 py-2 bg-gray-200 border border-gray-300 rounded-md text-sm font-semibold text-gray-700 hover:bg-gray-300">
                                        {{ __('Generate') }}
                                    </button>
                                </div>
                        ...
                        <div class="border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <x-input-label for="patrimony_number" :value="__('Patrimony Number')" />
                        ...
                        <div class="border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <x-input-label for="purchase_value" :value="__('Purchase Value (R$)' )" />
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('assets.index') }}" class="text-gray-600 hover:text-gray-900">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
