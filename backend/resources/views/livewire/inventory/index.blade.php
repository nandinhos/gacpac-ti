                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3">Inventário</th>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex flex-col">
                                                <span>{{ $inventory->sector->name ?? 'Geral (Todos)' }}</span>
                                                @if($inventory->is_commission)
                                                    <span class="mt-1 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800 w-fit">
                                                        {{ __('Comissão') }}
                                                    </span>
                                                @endif
                                            </div>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex justify-end space-x-2">
                                                ...
                                                <button wire:click="openReopenModal({{ $inventory->id }})" class="text-yellow-600 hover:text-yellow-900" title="Reabrir">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
