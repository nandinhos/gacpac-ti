        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <form action="<?php echo e(route('reports.assets')); ?>" method="GET" target="_blank" class="space-y-4">
                        <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <form action="<?php echo e(route('reports.maintenance')); ?>" method="GET" target="_blank" class="space-y-4">
                        <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <form action="<?php echo e(route('reports.term')); ?>" method="GET" target="_blank" class="space-y-4">
                        <div>
...
<?php /**PATH /var/www/html/resources/views/livewire/reports/index.blade.php ENDPATH**/ ?>