        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    <?php echo e(__('Manutenções')); ?>

                </h2>
                <p class="text-sm text-gray-500 mt-1">
                    Ativo: <span class="font-medium text-gray-700"><?php echo e($asset->name); ?></span>
                    (<?php echo e($asset->qr_code); ?>)
                </p>
            </div>
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('maintenance.create', $asset)); ?>"
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isEmbedded && session()->has('message')): ?>
            ...
            <div class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-blue-500">
                    <div class="p-4">
                        <p class="text-sm font-medium text-gray-600 uppercase"><?php echo e(__('Total de Registros')); ?></p>
                        <p class="text-2xl font-semibold text-gray-900"><?php echo e($records->total()); ?></p>
                    </div>
                </div>

                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-green-500">
                    <div class="p-4">
                        <p class="text-sm font-medium text-gray-600 uppercase"><?php echo e(__('Custo Total')); ?></p>
                        <p class="text-2xl font-semibold text-gray-900">R$ <?php echo e(number_format($totalCost, 2, ',', '.')); ?></p>
                    </div>
                </div>

                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 border-yellow-500">
                    <div class="p-4">
                        <p class="text-sm font-medium text-gray-600 uppercase"><?php echo e(__('Próxima Manutenção')); ?></p>
                        <?php
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            <?php echo e($next?->next_maintenance_date?->format('d/m/Y') ?? 'N/A'); ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('record-{{ $record->id }}', get_defined_vars()); ?>wire:key="record-<?php echo e($record->id); ?>">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($record->date->format('d/m/Y')); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($record->type === 'preventiva' ? 'bg-blue-100 text-blue-800' : 'bg-orange-100 text-orange-800'); ?>">
                                                <?php echo e(ucfirst($record->type)); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-900 max-w-xs">
                                            <div class="truncate"><?php echo e($record->description); ?></div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->is_upgrade): ?>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->parts_replaced): ?>
                                                <p class="text-[10px] text-gray-500 mt-1 italic">Peças: <?php echo e(Str::limit($record->parts_replaced, 50)); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <div><?php echo e($record->performed_by); ?></div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->notes): ?>
                                                <div class="text-[10px] text-gray-400 truncate max-w-[150px]" title="<?php echo e($record->notes); ?>"><?php echo e($record->notes); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->next_maintenance_date): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->next_maintenance_date->isPast()): ?>
                                                    <span class="text-red-600 font-medium"><?php echo e($record->next_maintenance_date->format('d/m/Y')); ?></span>
                                                <?php elseif($record->next_maintenance_date->diffInDays(now()) <= 30): ?>
                                                    <span class="text-yellow-600 font-medium"><?php echo e($record->next_maintenance_date->format('d/m/Y')); ?></span>
                                                <?php else: ?>
                                                    <span class="text-gray-600"><?php echo e($record->next_maintenance_date->format('d/m/Y')); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="flex justify-end space-x-2">
                                                <button type="button"
                                                        @click="$dispatch('open-delete-modal', { id: <?php echo e($record->id); ?> })"
...
<?php /**PATH /var/www/html/resources/views/livewire/maintenance/index.blade.php ENDPATH**/ ?>